...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">北京百晟乾坤咨询有限公司</div>
        <!-- 头部区域（可配合layui已有的水平导航） -->
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a href="userInfo.jsp">用户列表</a></li>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a class="layui-this" href="userInfo.jsp">用户列表</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
...
<script type="text/javascript">
    ...
    function onloadUserInfo(){
        window.location.href="/yishiInfo?state=1";
    }
</script>
</html>